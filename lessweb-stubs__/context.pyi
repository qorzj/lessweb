...
class Request:
    _body_data: Optional[bytes]  # Raw Body Input
    _url_input: Dict  # Input from URL
    _json_input: Optional[Dict]  # Input from Json Body
    _fields: Optional[Dict]  # Input from Json Body and Form Fields
    _cookies: Dict[str, str]
    _aliases: Dict[str, str]  # alias {realname: queryname}
    _pipe: Storage
    encoding: str
    environ: Dict = {}
    env: Dict = {}
...
class Response:
    ...
    _status: HttpStatus = HttpStatus.OK
